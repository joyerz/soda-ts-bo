 ...
 * 图片预览
 */
function PicPreviewer({ showList = true, url = [], style = {}, current = '', }) {
    let images = [];
    if (url) {
...
class UploadField extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement("div", { style: { position: 'relative' } },
            ...
            this.state.previewVisible && (React.createElement(PicPreview_1.default, { url: imagesUrls, showList: false, current: this.state.previewImage }))));
    }
}

...
export default connect(
  ...
  {
    actionList: params => accountListRedux.start(params),
    actionAdd: params => accountAddRedux.start(params),
    actionEdit: params => accountEditRedux.start(params),
    actionItem: params => accountItemRedux.start(params),
  },
)(Index)
